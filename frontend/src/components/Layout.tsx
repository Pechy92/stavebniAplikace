  ...
  return (
    <div className="min-h-screen bg-gradient-light transition-all duration-500">
      ...
      <nav className="sticky top-0 z-50 glass-bg border-b border-white/20 dark:border-gray-700/50">
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="sm:hidden p-2.5 rounded-xl glass-card hover:bg-white/90 dark:hover:bg-gray-700/90 transition-all duration-300"
        ...
        {mobileMenuOpen && (
          <div className="sm:hidden border-t border-white/20 dark:border-gray-700/50 px-4 pb-4 pt-3 space-y-2">
            <Link
              to="/dashboard"
            ...
            <button
              ...
              className="w-full mt-2 px-4 py-2 rounded-xl glass-card text-sm font-medium text-primary-600 hover:text-white hover:bg-gradient-to-r hover:from-primary-500 hover:to-primary-600 transition-all duration-300"
            >
              {t('nav.logout')}
            </button>
          </div>
